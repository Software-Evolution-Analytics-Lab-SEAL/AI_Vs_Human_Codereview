...
└── results/                           # Output directory
    ...
    ├── verify_feedbacktype_label.csv      # Manual validation: feedback-type labels (Cohen's kappa)
    └── verify_qualityattribute_label.csv  # Manual validation: quality-attribute labels
```
